...
-- Snarl <Expert Blacksmith>
UPDATE `creature_template` SET `subname`='Expert Blacksmith', `npcflag`=81 WHERE `entry`=1383;
...
-- Nogg <Expert Engineer>
UPDATE `creature_template` SET `subname`='Expert Engineer', `npcflag`=81 WHERE `entry`=3412;
...
-- Roxxik <Artisan Engineer>
UPDATE `creature_template` SET `subname`='Artisan Engineer', `npcflag`=81  WHERE `entry`=11017;
