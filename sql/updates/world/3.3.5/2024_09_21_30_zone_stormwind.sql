...
UPDATE `creature_template` SET `npcflag`=81 WHERE `entry`=957;
...
UPDATE `creature_template` SET `npcflag`=81 WHERE `entry`=1300;
...
UPDATE `creature_template` SET `npcflag`=81 WHERE `entry`=11026;

-- Betty Quin <Apprentice Enchanter>
UPDATE `creature_template` SET `npcflag`=81 WHERE `entry`=11068;

-- Randal Worth <Apprentice Leatherworker>
UPDATE `creature_template` SET `npcflag`=81 WHERE `entry`=11096;
...
-- Delete King Varian from Stormwind Keep.
delete from creature where id = 29611;
-- Remove the ambassador Draenei from Stormwind Keep.
delete from creature where id = 17103;
-- Remove the Wintergrasp Arcanist Battle-Mage from Stormwind Keep.
delete from creature where id = 35598;
