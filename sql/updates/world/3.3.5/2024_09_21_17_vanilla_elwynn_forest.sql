...
UPDATE `creature_template` SET `subname`='Apprentice Alchemist', `npcflag`=81 WHERE `entry`=5500;
...
UPDATE `creature_template` SET `npcflag`=81 WHERE `entry`=5567;
