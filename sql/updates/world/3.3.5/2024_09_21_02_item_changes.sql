-- Alter item_template table to support Vanilla negative resistance values
...
-- Alter quest template table to allow for bigger racial mask values.
alter table quest_template modify `AllowableRaces` int unsigned NOT NULL DEFAULT '0';
...
/*  Flurry Axe  */
-- [WRATH CHANGE] UPDATE `item_template` SET `BuyPrice` = 148139, `SellPrice` = 29627, `spellppmrate_1` = 1.8 WHERE entry=871;

/*  Rockslicer  */
-- [WRATH CHANGE] UPDATE `item_template` SET `Quality` = 2, `BuyPrice` = 10058, `SellPrice` = 2011, `dmg_min1` = 36.0, `dmg_max1` = 55.0, `MaxDurability` = 65, `stat_value1` = 7, `DisenchantID` = 23 WHERE entry=872;

/*  Staff of Jordan  */
-- [WRATH CHANGE] UPDATE `item_template` SET `spelltrigger_2` = 0, `spelltrigger_3` = 0, `spelltrigger_4` = 0, `spelltrigger_5` = 0 WHERE entry=873;
...
/*  Naga Battle Gloves  */
-- [WRATH CHANGE] UPDATE `item_template` SET `stat_type1` = 6 WHERE entry=888;
...
-- [WRATH CHANGE] UPDATE `item_template` SET `BuyPrice` = 2171, `stat_type1` = 3, `stat_type2` = 6, `stat_value2` = 3, `spellid_1` = 0, `spelltrigger_1` = 0, `StatsCount` = 2 WHERE entry=1929;
...
-- {WRATH CHANGES] UPDATE `item_template` SET `Quality` = 2, `stat_value1` = 2, `stat_type2` = 6, `stat_value2` = 7, `DisenchantID` = 5, `spellid_1` = 0, `spelltrigger_1` = 0, `StatsCount` = 2 WHERE entry=2043;
...
UPDATE `item_template` SET `BuyPrice` = 36620, `spellid_1` = 7679, `spellid_2` = 7708, `RequiredLevel` = 28 WHERE entry=2816;
...
/*  Bronze Mace  */
-- [WRATH CHANGES]-- UPDATE `item_template` SET `Quality` = 1, `BuyPrice` = 5595, `SellPrice` = 1119, `dmg_min1` = 18.0, `dmg_max1` = 34.0, `bonding` = 0, `stat_type1` = 0, `stat_value1` = 0, `DisenchantID` = 0 WHERE entry=2848;

/*  Bronze Axe  */
-- [WRATH CHANGES]-- UPDATE `item_template` SET `Quality` = 1, `BuyPrice` = 6345, `SellPrice` = 1269, `dmg_min1` = 15.0, `dmg_max1` = 29.0, `bonding` = 0, `stat_type1` = 0, `stat_value1` = 0, `DisenchantID` = 0 WHERE entry=2849;

/*  Bronze Shortsword  */
-- [WRATH CHANGES]-- UPDATE `item_template` SET `Quality` = 1, `BuyPrice` = 7197, `SellPrice` = 1439, `dmg_min1` = 16.0, `dmg_max1` = 31.0, `bonding` = 0, `stat_type1` = 0, `stat_value1` = 0, `DisenchantID` = 0 WHERE entry=2850;
...
/*  Raptor's End  */
-- [WRATH CHANGES]UPDATE `item_template` SET `dmg_min1` = 24.0, `dmg_max1` = 46.0 WHERE entry=3493;
...
-- [WRATH CHANGES]UPDATE `item_template` SET `dmg_min1` = 36.0, `dmg_max1` = 67.0 WHERE entry=4089;
...
/*  Black Tuxedo  */
-- [WRATH CHANGES]UPDATE `item_template` SET `RequiredLevel` = 0 WHERE entry=6834;

/*  Black Tuxedo Pants  */
-- [WRATH CHANGES]UPDATE `item_template` SET `armor` = 0, `BuyPrice` = 2521, `SellPrice` = 504, `MaxDurability` = 0 WHERE entry=6835;
...
-- [WRATH CHANGES]UPDATE `item_template` SET `BuyPrice` = 7615, `stat_type2` = 4 WHERE entry=6901;

/*  Bands of Serra'kis  */
-- [WRATH CHANGES]UPDATE `item_template` SET `Quality` = 2, `armor` = 39, `BuyPrice` = 4385, `SellPrice` = 877, `MaxDurability` = 30, `stat_type3` = 0, `stat_value3` = 0, `DisenchantID` = 4 WHERE entry=6902;

/*  Gaze Dreamer Pants  */
-- [WRATH CHANGES]UPDATE `item_template` SET `Quality` = 2, `armor` = 36, `BuyPrice` = 7747, `SellPrice` = 1549, `MaxDurability` = 50, `DisenchantID` = 4, `spellid_1` = 0, `spelltrigger_1` = 0 WHERE entry=6903;

/*  Reef Axe  */
-- [WRATH CHANGES]UPDATE `item_template` SET `Quality` = 2, `BuyPrice` = 20054, `SellPrice` = 4010, `dmg_min1` = 48.0, `dmg_max1` = 73.0, `MaxDurability` = 80, `stat_value1` = 5, `stat_type2` = 6, `stat_value2` = 7, `DisenchantID` = 24, `spellid_1` = 0, `spelltrigger_1` = 0, `StatsCount` = 2 WHERE entry=6905;

/*  Tortoise Armor  */
UPDATE `item_template` SET `BuyPrice` = 9364, `SellPrice` = 1872, `stat_type1` = 0, `stat_value1` = 0 WHERE entry=6907;

/*  Ghamoo-ra's Bind  */
-- [WRATH CHANGES]UPDATE `item_template` SET `Quality` = 2, `armor` = 22, `BuyPrice` = 2611, `SellPrice` = 522, `MaxDurability` = 25, `DisenchantID` = 3, `spellid_1` = 0, `spelltrigger_1` = 0 WHERE entry=6908;
...
/*  Annihilator  */
-- [WRATH UPDATES] UPDATE `item_template` SET `BuyPrice` = 285752, `SellPrice` = 57150, `DisenchantID` = 49, `spellppmrate_1` = 1.0 WHERE entry=12798;
...
-- [WRATH UPDATES] UPDATE `item_template` SET `armor` = 349, `BuyPrice` = 227412, `SellPrice` = 45482 WHERE entry=12903;

/*  Shawn's Super Special Swami Hat  */
-- [WRATH UPDATES] UPDATE `item_template` SET `armor` = 64, `BuyPrice` = 67923, `SellPrice` = 13584, `MaxDurability` = 45 WHERE entry=12904;
...
/*  Emberfury Talisman  */
-- [WRATH UPDATES] UPDATE `item_template` SET `fire_res` = 7, `stat_type2` = 6, `stat_type3` = 0, `stat_value3` = 0, `DisenchantID` = 49 WHERE entry=12929;

/*  Briarwood Reed  */
UPDATE `item_template` SET `DisenchantID` = 49 WHERE entry=12930;

/*  Warmaster Legguards  */
-- [WRATH UPDATES] UPDATE `item_template` SET `BuyPrice` = 115982, `SellPrice` = 23196, `stat_type3` = 0, `stat_value3` = 0, `DisenchantID` = 49, `spellid_1` = 13670 WHERE entry=12935;
...
-- [WRATH UPDATES] UPDATE `item_template` SET `BuyPrice` = 138586, `SellPrice` = 27717, `stat_value1` = 5, `stat_type2` = 0, `stat_value2` = 0, `DisenchantID` = 49, `spellid_3` = 13670 WHERE entry=12963;

/*  Tristam Legguards  */
-- [WRATH UPDATES] UPDATE `item_template` SET `BuyPrice` = 166942, `SellPrice` = 33388, `stat_type2` = 0, `stat_value2` = 0, `DisenchantID` = 49, `spellid_2` = 13670 WHERE entry=12964;

/*  Spiritshroud Leggings  */
UPDATE `item_template` SET `BuyPrice` = 111721, `SellPrice` = 22344, `DisenchantID` = 49 WHERE entry=12965;

/*  Blackmist Armguards  */
-- [WRATH UPDATES] UPDATE `item_template` SET `BuyPrice` = 70092, `SellPrice` = 14018, `shadow_res` = 10, `stat_type3` = 0, `stat_value3` = 0, `DisenchantID` = 49 WHERE entry=12966;

/*  Bloodmoon Cloak  */
-- [WRATH UPDATES] UPDATE `item_template` SET `BuyPrice` = 84420, `SellPrice` = 16884, `arcane_res` = 7, `stat_value1` = 17, `stat_type2` = 6, `stat_type3` = 0, `stat_value3` = 0, `DisenchantID` = 49 WHERE entry=12967;

/*  Frostweaver Cape  */
-- [WRATH UPDATES] UPDATE `item_template` SET `BuyPrice` = 84740, `SellPrice` = 16948, `frost_res` = 10, `stat_type3` = 0, `stat_value3` = 0, `DisenchantID` = 49 WHERE entry=12968;
...
/*  Silver-lined Belt  */
-- [WRATH UPDATES] UPDATE `item_template` SET `stat_type2` = 6, `stat_value2` = 4, `spellcooldown_1` = -1, `spellcategorycooldown_1` = -1 WHERE entry=13011;
...
/*  Harpyclaw Short Bow  */
-- [WRATH UPDATES] UPDATE `item_template` SET `BuyPrice` = 23828, `dmg_min1` = 20.0, `dmg_max1` = 38.0 WHERE entry=13019;

/*  Skystriker Bow  */
-- [WRATH UPDATES] UPDATE `item_template` SET `BuyPrice` = 44927, `dmg_min1` = 30.0, `dmg_max1` = 57.0 WHERE entry=13020;

/*  Needle Threader  */
-- [WRATH UPDATES] UPDATE `item_template` SET `dmg_min1` = 34.0, `dmg_max1` = 64.0 WHERE entry=13021;

/*  Gryphonwing Long Bow  */
-- [WRATH UPDATES] UPDATE `item_template` SET `BuyPrice` = 139952, `dmg_min1` = 53.0, `dmg_max1` = 100.0 WHERE entry=13022;

/*  Eaglehorn Long Bow  */
-- [WRATH UPDATES] UPDATE `item_template` SET `BuyPrice` = 213515, `SellPrice` = 42703, `dmg_min1` = 40.0, `dmg_max1` = 76.0, `DisenchantID` = 49 WHERE entry=13023;
...
/*  Warmonger  */
-- [WRATH UPDATES] UPDATE `item_template` SET `BuyPrice` = 208388, `stat_type2` = 0, `stat_value2` = 0, `spellid_1` = 15466 WHERE entry=13052;
...
/*  Widow's Clutch  */
-- [WRATH UPDATES] UPDATE `item_template` SET `armor` = 89, `MaxDurability` = 80, `shadow_res` = 0, `arcane_res` = 13, `DisenchantID` = 0 WHERE entry=13080;
...
-- [WRATH UPDATES] UPDATE `item_template` SET `BuyPrice` = 7155, `stat_type2` = 3, `stat_value2` = 3, `spellid_1` = 0, `spelltrigger_1` = 0, `StatsCount` = 2 WHERE entry=13099;
...
-- [WRATH UPDATES] UPDATE `item_template` SET `BuyPrice` = 6081, `stat_type2` = 4, `stat_value2` = 3, `spellid_1` = 0, `spelltrigger_1` = 0, `spellcooldown_1` = -1, `StatsCount` = 2 WHERE entry=13106;

/*  Magiskull Cuffs  */
UPDATE `item_template` SET `BuyPrice` = 56457, `SellPrice` = 11291, `DisenchantID` = 49, `spellcooldown_1` = -1 WHERE entry=13107;

/*  Wolffear Harness  */
-- [WRATH UPDATES] UPDATE `item_template` SET `BuyPrice` = 24840, `stat_type2` = 6 WHERE entry=13110;

/*  Sandals of the Insurgent  */
UPDATE `item_template` SET `BuyPrice` = 69968 WHERE entry=13111;

/*  Winged Helm  */
-- [WRATH UPDATES] UPDATE `item_template` SET `BuyPrice` = 48124, `SellPrice` = 9624, `stat_type1` = 6, `stat_type2` = 5, `stat_value2` = 23 WHERE entry=13112;

/*  Feathermoon Headdress  */
-- [WRATH UPDATES] UPDATE `item_template` SET `BuyPrice` = 102730, `SellPrice` = 20546, `stat_type1` = 6, `stat_value1` = 21, `DisenchantID` = 49, `StatsCount` = 3 WHERE entry=13113;

/*  Troll's Bane Leggings  */
-- [WRATH UPDATES] UPDATE `item_template` SET `BuyPrice` = 12870, `stat_type2` = 6, `stat_value2` = 4 WHERE entry=13114;

/*  Sheepshear Mantle  */
-- [WRATH UPDATES] PDATE `item_template` SET `BuyPrice` = 34954, `SellPrice` = 6990, `stat_type1` = 5, `stat_value1` = 16, `stat_type3` = 6 WHERE entry=13115;
...
-- [WRATH UPDATES] UPDATE `item_template` SET `stat_type1` = 6 WHERE entry=13124;

/*  Elven Chain Boots  */
-- [WRATH UPDATES] UPDATE `item_template` SET `stat_type3` = 6 WHERE entry=13125;

/*  Battlecaller Gauntlets  */
-- [WRATH UPDATES] UPDATE `item_template` SET `BuyPrice` = 51870, `stat_type1` = 4, `stat_type3` = 6, `stat_value3` = 15 WHERE entry=13126;

/*  Frostreaver Crown  */
-- [WRATH UPDATES] UPDATE `item_template` SET `stat_type3` = 6 WHERE entry=13127;

/*  High Bergg Helm  */
-- [WRATH UPDATES] UPDATE `item_template` SET `stat_type1` = 6 WHERE entry=13128;

/*  Windrunner Legguards  */
-- [WRATH UPDATES] UPDATE `item_template` SET `stat_type2` = 6 WHERE entry=13130;

/*  Drakesfire Epaulets  */
UPDATE `item_template` SET `BuyPrice` = 115416, `SellPrice` = 23083, `DisenchantID` = 49 WHERE entry=13133;

/*  Lil Timmy's Peashooter  */
-- [WRATH UPDATES] UPDATE `item_template` SET `BuyPrice` = 7280, `dmg_min1` = 20.0, `dmg_max1` = 37.0 WHERE entry=13136;

/*  Ironweaver  */
-- [WRATH UPDATES] UPDATE `item_template` SET `dmg_min1` = 31.0, `dmg_max1` = 59.0 WHERE entry=13137;

/*  The Silencer  */
-- [WRATH UPDATES] UPDATE `item_template` SET `dmg_min1` = 43.0, `dmg_max1` = 82.0 WHERE entry=13138;

/*  Guttbuster  */
-- [WRATH UPDATES] UPDATE `item_template` SET `dmg_min1` = 49.0, `dmg_max1` = 92.0 WHERE entry=13139;

/*  Tooth of Gnarr  */
UPDATE `item_template` SET `DisenchantID` = 49 WHERE entry=13141;

/*  Brigam Girdle  */
-- [WRATH UPDATES] UPDATE `item_template` SET `BuyPrice` = 58210, `SellPrice` = 11642, `stat_type3` = 0, `stat_value3` = 0, `DisenchantID` = 49, `spellid_1` = 15464 WHERE entry=13142;
...
-- [WRATH UPDATES] UPDATE `item_template` SET `dmg_min1` = 48.0, `dmg_max1` = 89.0 WHERE entry=13146;
...
/*  Demonskin Gloves  */
-- [WRATH UPDATES] UPDATE `item_template` SET `BuyPrice` = 43988, `stat_type1` = 6, `stat_value1` = 17, `stat_type3` = 7, `stat_value3` = 9, `spellid_1` = 0, `spelltrigger_1` = 0, `StatsCount` = 3 WHERE entry=13181;
...
/*  Sunderseer Mantle  */
-- [WRATH UPDATES] UPDATE `item_template` SET `BuyPrice` = 82111, `SellPrice` = 16422, `stat_value1` = 17, `stat_value2` = 11, `DisenchantID` = 49, `spellid_1` = 9398 WHERE entry=13185;
...
/*  Burstshot Harquebus  */
-- [WRATH UPDATES] UPDATE `item_template` SET `dmg_min1` = 52.0, `dmg_max1` = 98.0 WHERE entry=13248;
...
/*  Globe of D'sak  */
-- [WRATH UPDATES] UPDATE `item_template` SET `shadow_res` = 7, `stat_type1` = 5, `stat_type3` = 0, `stat_value3` = 0 WHERE entry=13261;

/*  Ashbringer  */
UPDATE `item_template` SET `BuyPrice` = 1307038, `SellPrice` = 261407 WHERE entry=13262;

/*  Ogreseer Tower Boots  */
-- [WRATH UPDATES] UPDATE `item_template` SET `stat_type2` = 6, `spelltrigger_1` = 0 WHERE entry=13282;

/*  Magus Ring  */
-- [WRATH UPDATES] UPDATE `item_template` SET `stat_value1` = 12, `stat_type2` = 6, `stat_value2` = 7, `spellcooldown_1` = -1, `spellcategorycooldown_1` = -1 WHERE entry=13283;
...
-- [WRATH UPDATES] UPDATE `item_template` SET `BuyPrice` = 192216, `SellPrice` = 38443, `dmg_min1` = 63.0, `dmg_max1` = 118.0, `DisenchantID` = 49 WHERE entry=13380;
...
-- [WRATH UPDATES] UPDATE `item_template` SET `BuyPrice` = 79478, `stat_type2` = 0, `stat_value2` = 0, `stat_type3` = 0, `stat_value3` = 0, `spellid_1` = 15465, `spellid_2` = 7597 WHERE entry=13404;
...
-- [WRATH UPDATES] UPDATE `item_template` SET `BuyPrice` = 123624, `SellPrice` = 24724, `dmg_min1` = 34.0, `dmg_max1` = 64.0 WHERE entry=13474;
...
/*  Recurve Long Bow  */
-- [WRATH UPDATES] UPDATE `item_template` SET `dmg_min1` = 26.0, `dmg_max1` = 50.0 WHERE entry=13824;

/*  Primed Musket  */
-- [WRATH UPDATES] UPDATE `item_template` SET `BuyPrice` = 50841, `dmg_min1` = 20.0, `dmg_max1` = 37.0 WHERE entry=13825;
...
/*  Mystic's Belt  */
-- [WRATH UPDATES] UPDATE `item_template` SET `BuyPrice` = 941, `stat_type2` = 3, `stat_value2` = 2, `spellid_1` = 0, `spelltrigger_1` = 0, `StatsCount` = 2 WHERE entry=14025;
...
/*  Cursed Felblade  */
-- [WRATH UPDATES] UPDATE `item_template` SET `Quality` = 2, `BuyPrice` = 5161, `SellPrice` = 1032, `dmg_min1` = 16.0, `dmg_max1` = 31.0, `MaxDurability` = 55, `DisenchantID` = 22 WHERE entry=14145;

/*  Gloves of Spell Mastery  */
-- [WRATH UPDATES] UPDATE `item_template` SET `armor` = 60, `BuyPrice` = 70421, `SellPrice` = 14084 WHERE entry=14146;

/*  Cavedweller Bracers  */
-- [WRATH UPDATES] UPDATE `item_template` SET `Quality` = 2, `armor` = 71, `BuyPrice` = 1559, `SellPrice` = 311, `MaxDurability` = 25, `stat_value1` = 1, `stat_value2` = 2, `DisenchantID` = 2 WHERE entry=14147;

/*  Crystalline Cuffs  */
-- [WRATH UPDATES] UPDATE `item_template` SET `Quality` = 2, `armor` = 14, `BuyPrice` = 1043, `SellPrice` = 208, `stat_value2` = 1, `DisenchantID` = 2, `spellid_1` = 0, `spelltrigger_1` = 0 WHERE entry=14148;

/*  Subterranean Cape  */
-- [WRATH UPDATES] UPDATE `item_template` SET `Quality` = 2, `armor` = 16, `BuyPrice` = 1538, `SellPrice` = 307, `stat_value1` = 2, `stat_value2` = 2, `DisenchantID` = 2 WHERE entry=14149;

/*  Robe of Evocation  */
-- [WRATH UPDATES] UPDATE `item_template` SET `Quality` = 2, `armor` = 32, `BuyPrice` = 2103, `SellPrice` = 420, `MaxDurability` = 55, `stat_value1` = 4, `stat_value2` = 3, `stat_type3` = 0, `stat_value3` = 0, `DisenchantID` = 2 WHERE entry=14150;

/*  Chanting Blade  */
-- [WRATH UPDATES] UPDATE `item_template` SET `Quality` = 2, `BuyPrice` = 5279, `SellPrice` = 1055, `dmg_min1` = 9.0, `dmg_max1` = 18.0, `MaxDurability` = 40, `stat_value1` = 1, `stat_value2` = 1, `DisenchantID` = 22 WHERE entry=14151;

/*  Robe of the Archmage  */
-- [WRATH UPDATES] UPDATE `item_template` SET `armor` = 96, `BuyPrice` = 144077, `SellPrice` = 28815 WHERE entry=14152;

/*  Robe of the Void  */
-- [WRATH UPDATES] UPDATE `item_template` SET `armor` = 96, `BuyPrice` = 144603, `SellPrice` = 28920, `spelltrigger_3` = 0 WHERE entry=14153;

/*  Truefaith Vestments  */
-- [WRATH UPDATES] UPDATE `item_template` SET `armor` = 96, `BuyPrice` = 145144, `SellPrice` = 29028 WHERE entry=14154;
...
UPDATE `item_template` SET `spellid_1` = 30161, `spellcharges_1` = 0, `spellcooldown_1` = 600000 WHERE entry=23714;

/*  Carved Ogre Idol  */
-- UPDATE `item_template` SET `Quality` = 1, `spellid_1` = 30167, `spellcharges_1` = 0, `spellcooldown_1` = 3600000 WHERE entry=23716;
UPDATE `item_template` SET `spellid_1` = 30167, `spellcharges_1` = 0, `spellcooldown_1` = 3600000 WHERE entry=23716;
...
/* Blinding Powder */
UPDATE item_template SET name = 'Blinding Powder', subclass = 1, Quality = 1, description = '' WHERE entry=5530;
